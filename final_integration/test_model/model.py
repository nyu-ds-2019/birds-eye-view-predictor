...
class Encoder(nn.Module):
    def __init__(self, num_layers, img_ht, img_wt, ssl_dict, pretrained=True):
        super(Encoder, self).__init__()

        self.resnet_encoder = ResnetEncoder(num_layers, pretrained, ssl_dict)#opt.weights_init == "pretrained"))
